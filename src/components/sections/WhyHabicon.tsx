            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 max-w-6xl mx-auto">
                    {values.map((value, index) => (
                        <motion.div
                            key={value.title}
                            className="glass-card p-6 md:p-10 rounded-2xl border border-border/50 hover:border-primary/50 transition-all duration-300 hover:bg-card/80"
                        ...
                        >
                            <div className="flex items-start gap-4 md:gap-6">
                                <div className="p-3 md:p-4 rounded-xl bg-primary/10 border border-primary/20">
                                    <value.icon className="text-primary w-6 h-6 md:w-8 md:h-8" />
                                </div>
                                <div className="flex-1">
                                    <h3 className="text-lg md:text-2xl font-bold text-foreground mb-2">
                                        {value.title}
                                    </h3>
                                    <p className="text-body text-muted-foreground leading-relaxed md:text-lg">
                                        {value.description}
                                    </p>
                                </div>
                            </div>
